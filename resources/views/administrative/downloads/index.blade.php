            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Downloads List</h4>
                        <div>
                            <a href="{{ route('administrative.downloads.create') }}"
...
@section('page-js')
    <script>
        $(document).ready(function() {
            $(function() {
                var table = $('#datatable').DataTable({
                    ...
                    serverSide: true,
                    stateSave: true,
                    ajax: "{{ route('administrative.downloads.data') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
        ...
        function deleteData(rowid) {
            let url = "{{ route('administrative.downloads.destroy', ':id') }}";
