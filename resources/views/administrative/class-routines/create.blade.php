            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Add New Class Routine</h4>
                    ...
                    <form class="needs-validation" novalidate
                        action="{{ route('administrative.class-routines.store') }}" method="POST"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="pdf">PDF File<strong class="text-danger">*</strong></label>
