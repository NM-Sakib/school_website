            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Class Routines List</h4>
                        <div>
                            <a href="{{ route('administrative.class-routines.create') }}"
...
@section('page-js')
    <script>
        $(document).ready(function() {
            $(function() {
                var table = $('#datatable').DataTable({
                    ...
                    serverSide: true,
                    stateSave: true,
                    ajax: "{{ route('administrative.class-routines.data') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
        ...
        function deleteData(rowid) {
            let url = "{{ route('administrative.class-routines.destroy', ':id') }}";
