        ...
        <td class="container">
            <div class="content">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                    ...
                    <tr>
                        <td class="wrapper">
                            <img class="invitation" src="{{asset('assets/images/logo-dashboard.png')}}" alt="Invitation"/>
                            <p>Hi {{$data['name']}}</p>
                            <p>You have been invited to {{$data['instance_name']}}.
                                Please show the email when you get there.</p>
                            ...
                            <p>Please do not share this email or QR with anyone.
                                This is a unique QR code, and it has limited scanability.</p>
                            ...
                            <table class="content">
                                <tr>
                                    <td><small>This QR code can be used <b>{{$data['scan_limitation']}}</b> Time(s) Only.</small></td>
                                </tr>
                            </table>
