...
@section('content')
    <div class="container">
        ...
        <form id="create-profile" enctype="multipart/form-data" action="{{ route('member.create') }}"
            ...
            <div class="row setup-content" id="step-1">
                <div class="col-xs-12">
                    <div class="col-md-12">
                        <h3> Step 1</h3>
                        <div class="row mb-3">
                            <label for="name" class="col-sm-2 form-label">Name<span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input class="form-control" required type="text" value="{{old('name')}}" name="name" placeholder=""
                                    id="name">
                            </div>
                        </div>
