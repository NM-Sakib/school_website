    ...
    AIZ.uploader = {
                    ...
                    $(".aiz-uploader-confirmed-delete").on("click", function (
                        ...
                        if (e.detail === 1) {
                            ...
                            $.ajax({
                                url:
                                    AIZ.data.appUrl +
                                    "/administrative/aiz-uploader/destroy/" +
                                    AIZ.uploader.data.clickedForDelete,
                                type: "DELETE",
                                dataType: "JSON",
                                data: {
                                ...
                                success: function () {
                                    ...
                                    AIZ.uploader.getAllUploads(
                                        AIZ.data.appUrl +
                                            "/administrative/aiz-uploader/get_uploaded_files"
                                    );
        ...
        showSelectedFiles: function () {
            $('[name="aiz-show-selected"]').on("change", function () {
                if ($(this).is(":checked")) {
                    ...
                    // }
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/administrative/aiz-uploader/get_uploaded_files"
                    );
                }
                AIZ.uploader.updateUploaderFiles();
            });
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            ...
                            thumb =
                                '<div class="uppy-DashboardItem-previewInnerWrap" style="background-color: #556ee6;"><i class="ri-video-fill"></i></div>';
                        } else {
                            thumb = '<div class="uppy-DashboardItem-previewInnerWrap" style="background-color: #f46a6a;"><i class="ri-file-line"></i></div>';
                        }
                        var html =
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post(
                    AIZ.data.appUrl + "/administrative/aiz-uploader/get_file_by_ids",
                        ...
                        if (data.length > 0) {
                            ...
                            for (
                                ...
                                var html =
                                    ...
                                    "</div>" +
                                    '<div class="remove">' +
                                    '<button class="btn btn-sm btn-light remove-attachment" type="button">' +
                                    '<i class="ri-close-line text-danger align-middle"></i>' +
                                    "</button>" +
                                    "</div>" +
                                    "</div>";
        ...
        trigger: function (
            ...
            // setTimeout(function() {
            $.post(
                AIZ.data.appUrl + "/administrative/aiz-uploader",
                { _token: AIZ.data.csrf },
                function (data) {
                    $("body").append(data);
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.use(Uppy.XHRUpload, {
                    endpoint: AIZ.data.appUrl + "/administrative/aiz-uploader/upload",
                    fieldName: "aiz_file",
                    formData: true,
                    headers: {
    ...
    AIZ.extra = {
        ...
        deleteConfirm: function () {
            ...
            $(".confirm-alert").click(function (e) {
                ...
                $(target).modal("show");
                $(target).find(".confirm-link").attr("href", url);
            });
        },
